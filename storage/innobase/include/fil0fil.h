...
struct fil_node_t {
	...
	/** Same as close() but leaks file handle instead of closing it. */
	pfs_os_file_t leak_handle();

private:
	/** Does stuff common for close() and leak_handle() */
	void prepare_to_close_or_leak_handle();
};
